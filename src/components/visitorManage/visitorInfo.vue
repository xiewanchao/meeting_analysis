<template>
  <div class="visitorInfo-wrapper">
    ...
    <InfoSearch @InfoSearch="visitorInfoSearch" class="info-search">
      ...
      <el-input
        placeholder="请输入参会人员是否为常驻人员"
        v-model="visitorCredit"
        id="visitorCredit"
        class="search-item visitorCredit"
      >
        <template slot="prepend">常驻人员</template>
      </el-input>
    </InfoSearch>
    ...
    <div class="info-result-wrapper">
      ...
      <div class="info-result">
        ...
        >
          ...
          <el-table-column prop="guestCredit" label="学号" header-align="center"></el-table-column>
          ...
          <el-table-column prop="guestCredit" label="常驻人员" header-align="center"></el-table-column>
        </el-table>
