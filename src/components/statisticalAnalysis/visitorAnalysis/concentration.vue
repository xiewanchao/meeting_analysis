<template>
  <div class="behaviorAnalysis-wrapper">
    ...
    <button v-if="!iscon" @click="startCon">
      专注度检测开始
    </button>
    <button v-if="iscon" class="orange" @click="stopCon">
      Stop
    </button>
    <div class='bottom'>
      <div id="drawGuestConcen" class="drawGuestConcen" ></div>
      <div id="drawGuestConcen2" class="drawGuestConcen2"></div>
